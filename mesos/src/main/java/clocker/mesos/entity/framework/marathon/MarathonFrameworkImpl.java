...
import clocker.mesos.entity.framework.MesosFrameworkImpl;
...
import clocker.mesos.location.framework.marathon.MarathonResolver;
...
public class MarathonFrameworkImpl extends MesosFrameworkImpl implements MarathonFramework {
    ...
    public String startApplication(String id, Map<String, Object> flags) {
        ...
        Optional<String> result = MesosUtils.httpPost(this, "v2/apps", "classpath:///clocker/mesos/entity/framework/marathon/create-app.json", substitutions);
        if (!result.isPresent()) {
